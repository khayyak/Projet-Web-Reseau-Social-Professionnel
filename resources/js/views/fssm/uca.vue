                ...
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-lg-6">
                        <div class="about-text go-to">
                            <h3 class="dark-color">Unversité Cadi Ayyad</h3>
                            <div class="row about-list">
                                <div class="col-md-6">
                                    ...
                                    <div class="media">
                                        <label>Address</label>
                                        <p>Av Abdelkrim Khattabi, Marrakech</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="media">
                    ...
                    <div class="col-lg-6">
                        <div class="about-avatar">
                            <img src="https://www.linkpicture.com/q/logo_51.png" title="" alt="">
                        </div>
                    </div>
                </div>
                <div class="counter">
                    <div class="row">
                        <div class="col-6 col-lg-3">
                            <div class="count-data text-center">
                                <h6 class="count h2" data-to="500" data-speed="500">12000</h6>
                        ...
                        <div class="col-6 col-lg-3">
                            <div class="count-data text-center">
                                ...
                                <p class="m-0px font-w-600">facultés / écoles</p>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3">
                            <div class="count-data text-center">
