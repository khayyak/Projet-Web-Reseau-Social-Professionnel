<template>
  ...
  <section class="header-content">
    <figure class="header-img">
      <img src="https://www.linkpicture.com/q/our-students.jpg" alt="Man holding camera looking at fireworks"></figure>
    <div class="header-description container">
      <h2 class="header-title">Apprendre. Partager. </h2>
      <p>Cette réseau social professionnel vous aide à vous connecter et à partager avec les personnes de votre vie professionnel. </p>
      <button @click="toSignup()" class="type-button">Créer compte</button>
    </div>
  </section>
</header>
  </div>
...
export default {
  methods: {
    ...
    toSignup() {
              this.$router.push({ path: 'enregistrer' });
    },
    toAutour() {
