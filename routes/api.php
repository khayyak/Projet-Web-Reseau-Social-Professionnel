...
Route::namespace('Api')->group(function() {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        //Reactions
        Route::get('reactions/list/{id}', [postController::class, 'getReactions']);
        Route::post('addReaction/{id}', [postController::class, 'addReaction']);
        Route::post('deleteReaction/{id}', [postController::class, 'deleteReaction']);
        //Comments
        Route::get('comments/list/{id}', [postController::class, 'getComments']);
        Route::post('addComment/{comment}/{post}', [postController::class, 'addComment']);

        //Questions
        Route::post('addUser/{annee}/{fq}/{sq}/{tq}', [SignupController::class, 'addUser']);
...
Route::get('questions/{annee}', [SignupController::class, 'getQuestions']);
Route::post('addUser/{annee}/{fq}/{sq}/{tq}', [SignupController::class, 'addUser']);
